$('.enter_home').hover(function() {
	$(this).find('em').addClass('line_cirl').removeClass('line_cirl1')
	$(this).addClass('yyc_show').removeClass('yyc_hidden')
}, function() {
	$(this).find('em').addClass('line_cirl1').removeClass('line_cirl')
	$(this).addClass('yyc_hidden').removeClass('yyc_show')
})

function auto_play() {
	$('.enter_home').addClass('auto_play')
	$('.left_ts').find('img').addClass('auto_play')
}
auto_play()
function initVars() {
			pi = Math.PI;
